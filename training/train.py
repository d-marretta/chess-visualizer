...
def train_seg():
    ...
    model.train(data='./training/seg_dataset.yaml', project='chessboard_segment', epochs=50, imgsz=640, patience=8, device=0, batch=32)
...
def train_detect():
    ...
    model.train(data='./training/detect_dataset.yaml', project='detect_pieces', epochs=50, imgsz=640, patience=10, device=0, batch=32)
